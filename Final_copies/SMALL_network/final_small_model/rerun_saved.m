...
load TESTv1_lesion_sat0.94_atpthr10.mat
file_vessel='XY.mat';
...
% S0(S0<0)=0;
% save('S0_gauss_4,1','S0');
load('OE_healthy');
OE0=OEhealthy;

[OE,OEn,CMRO2n]=init_func_mod_final(S0,bndry,neu_size,PO2tisv,L0,d0,W_gauss,file_vessel,OE0);
% OEhealthy=OEn;
...
%     for jj=1:length(pos)
        ...
        options2 = ddeset('RelTol',1e-5,'AbsTol',1e-5);
        options3 = odeset(options2,'NonNegative',1);
        [x]=dde23(@(t,x,z)  function4DDE(t,x,z,Ae,opts,input1,CMRO2nref,ATPref,PO2tis4art,W_gauss,loc_vas,Sen,file_vessel,file_vessel_chara,training,lissom,tau,Fin0,Fout0,V0,PO2tismax,ATPmax,Waffref,thr_atp),lags,x0,time_span,options3);
...
% end
x=Sint';
save('Rerun1.mat','lissom','ATPmax','x','E','N1','N2','bndry','para','neu_size','nE','L0','S0','Fin0','Fout0','V0','cnt','neuout','Ttime','MinATP','thr_atp','opts');
