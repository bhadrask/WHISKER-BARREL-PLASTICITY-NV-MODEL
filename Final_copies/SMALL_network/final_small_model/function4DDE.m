function dxdt=function4DDE(t,x,z,Ae,opts,input1,CMRO2nref,ATPref,PO2tis4art,W_gauss,loc_vas,sen,file_xy,file_vess_char,training,LISSOM,tau,Fin0,Fout0,V0,PO2tismax,ATPmax,Waffref,thr_atp)
%% definitions
...
[dCMRO2ndt,OEn]=vsc_func7_Avg_bsk_mod(OE1,bndry,neu,CMRO2nref,W_gauss,file_xy,CMRO2n,PO2tis,PO2tismax);
