...
image_settings;
figure(4)
[ha4, pos4] = tight_subplot(4,5,[0.03 0.01],[0.02 .08],[.01 .1]);
figure(5)
[ha5, pos5] = tight_subplot(4,5,[0.03 0.01],[0.02 .08],[.01 .1]);
figure(6)
[ha6, pos6] = tight_subplot(4,5,[0.03 0.01],[0.02 .08],[.01 .1]);
figure(7)
[ha7, pos7] = tight_subplot(4,5,[0.03 0.01],[0.02 .08],[.01 .1]);
figure(8)
[ha8, pos8] = tight_subplot(4,5,[0.03 0.01],[0.02 .08],[.01 .1]);
