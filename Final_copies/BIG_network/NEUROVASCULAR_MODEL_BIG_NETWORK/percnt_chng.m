function [delF,delV,delS,delHbT,delHbO,delHb]=percnt_chng(F,V,S,HbT,HbO,Hb,X,Y,lev,bndry,ind,PO2tissn,beta)
...
for i=4%2:lev(end)-1
   ...
   figure(ind); subplot(3,3,8);
    ...
    plotneuside(delPO2,64,64); title('po2tiss')
end